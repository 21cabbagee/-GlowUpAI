...
def create_complete_app(service: CompleteSkinProofService | None = None) -> FastAPI:
    ...
    def update_experience_profile(user_id: str, payload: ExperienceProfileUpdate):
    ...
    def upgrade(user_id: str, payload: UpgradeCreate):
    ...
    def confound_check(user_id: str, exclude_product_id: str | None = None):
    ...
    def experiment(payload: ExperimentCreate):
    ...
    def labels(user_id: str):
        return run(active.labels, user_id)

    @app.post("/api/users/{user_id}/labels")
    def add_label(user_id: str, payload: LabelCreate):
